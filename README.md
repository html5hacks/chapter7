...
To access the latest code from a particular chapter, clone the repo, `git clone git@github.com:html5hacks/chapter7.git`, or [download the latest release](https://github.com/html5hacks/chapter7/archive/master.zip).
